...
import { MapPin, Star, TrendingUp, Search, Globe } from 'lucide-react';
      ...
      <div className="bg-slate-950 pt-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-900/30 text-emerald-400 text-xs font-bold mb-4">
                LOCAL DOMINANCE ENGINE
              </div>
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                Own Your Backyard. <br/>
                <span className="text-emerald-500">Rank #1 Locally.</span>
              </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-24">
            <div className="glass-card p-8 rounded-2xl group hover:border-emerald-500/50 transition-colors">
              ...
              <h3 className="text-xl font-bold text-white mb-3">GMB Optimization</h3>
              <p className="text-slate-400 text-sm">
                Our AI continuously updates your Google Business Profile with keywords, posts, and photos to signal relevance to Google's algorithm.
              </p>
            </div>
            <div className="glass-card p-8 rounded-2xl group hover:border-emerald-500/50 transition-colors">
              <Star className="h-10 w-10 text-yellow-400 mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-bold text-white mb-3">Review Automation</h3>
              <p className="text-slate-400 text-sm">
                Automatically request reviews via SMS after service. Our AI drafts professional responses to all reviews—positive or negative—instantly.
              </p>
            </div>
            <div className="glass-card p-8 rounded-2xl group hover:border-emerald-500/50 transition-colors">
              <MapPin className="h-10 w-10 text-red-400 mb-4 group-hover:scale-110 transition-transform" />
              <h3 className="text-xl font-bold text-white mb-3">Hyper-Local Citations</h3>
              <p className="text-slate-400 text-sm">
                We build thousands of consistent NAP (Name, Address, Phone) citations across local directories to boost your domain authority.
              </p>
            </div>
          </div>
             ...
             <div className="flex flex-col md:flex-row gap-12 items-center">
                <div className="flex-1">
                   ...
                   <p className="text-slate-400 mb-6">
                      Before Cort X AI, they ranked on page 2 for "AC Repair Chicago". Within 60 days of our automated local SEO implementation:
                   </p>
